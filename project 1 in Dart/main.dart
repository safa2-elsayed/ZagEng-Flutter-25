...
void EditCategory(List<Category> categories) {
  ...
  if (!found) print("This Category Is Not Found ");
}
...
void AddNewTask(List<Category> categories) {
  ...
  if (!foundCategory) print("This Category Is Not Found");
}

void EditTask(List<Category> categories) {
  bool foundCategory = false;
  ...
  categories.forEach((category) {
    if (category.getName() == input) {
      ...
      if (!foundTask) print("This Task Is Not Found");
    }
  });
  if (!foundCategory) print("This Category Is Not Found");
}
